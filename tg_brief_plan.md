...
#### Ориентир: сколько остаётся с подписки $5 (2026-09-24)

Основной кандидат — подписка $5 в месяц через Telegram Stars. Схема с балансом и оплатой
за прочитанное (ниже) отложена.

| Способ оплаты | Остаётся с $5 | Нюансы |
|---|---|---|
| Telegram Stars (внутри бота) | ≈ $3.1–3.2 (≈ 63–65%) | Единственный разрешённый способ для цифровых услуг в боте; подписка встроена. Вывод в TON через Fragment, первый — через 21 день, ~1–3% на обмен TON → деньги |
| Карта на своём сайте (Stripe и т.п.) | ≈ $4.6–4.7 (≈ 93%) | Серая зона: за продажу в обход Stars Telegram может скрыть или заблокировать бота |
| Боты-посредники, крипта (Tribute, CryptoBot / Wallet Pay) | ≈ $4.5–4.9 | Комиссия ~1–10%, риск тот же, что у сайта; условия не проверены |

Минус токены: с `gpt-5-nano` ≈ $0.3–0.5 на активного пользователя в месяц.
**Чистыми через Stars ≈ $2.6–2.8 с подписчика в месяц**, через сайт ≈ $4.1–4.4.

Откуда потеря на Stars: Stars пользователи покупают в iOS/Android-приложении, и магазины берут
свою комиссию (Apple: 30%, 15% для малого бизнеса до $1M в год и для подписок после первого года;
Google: 15% с первого $1M в год и с подписок, 30% выше). Остальное — комиссия Telegram и НДС.

#### Монетизация: баланс и оплата за прочитанное — отложено (2026-09-24)

Черновик-ориентир, к реализации не планируется.
